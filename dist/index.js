  ...
  [
    [
      ...
      [
        "docker-icon",
        ["dark-blue", "dark-blue"],
        /^(?:Dockerfile(\.\w+$|)|docker-compose)|\.docker(?:file|ignore)$/i,
        2,
        false,
        ,
        /\.dockerfile$/i,
      ...
      [
        "config-icon",
        ["medium-yellow", "medium-yellow"],
        /\.(?:ini|desktop|directory|cfg|conf|prefs)$|MANIFEST\.in$/i,
        ,
        false,
        ,
        /\.ini$/i,
    ...
    [
      [
        69, 147, 152, 154, 169, 192, 195, 196, 197, 198, 204, 217, 239, 244, 249, 251,
        253, 258, 287, 292, 293, 303, 304, 309, 331, 333, 336, 343, 347, 353, 362, 380,
        395, 398, 416, 420, 421, 422, 424, 431, 434, 448, 451, 465, 467, 468, 471, 480,
        481, 482, 485, 486, 487, 525, 526, 529, 534, 555, 565, 570, 571, 572, 578, 580,
        584, 586, 590, 601, 602, 626, 629, 658, 669, 670, 681, 688, 694, 696, 709, 714,
        715, 745, 748, 755, 760, 769, 772, 778, 779, 798, 800, 803, 805, 808, 811, 822,
        823, 826, 836, 838, 848, 854, 858, 860, 864, 865, 867, 868, 871, 881, 886, 903,
        905, 924, 928, 936, 944, 987, 1e3, 1003, 1005, 1023,
      ],
      [
        42, 57, 69, 105, 120, 121, 124, 126, 129, 143, 145, 147, 149, 151, 152, 154, 156,
        157, 158, 166, 167, 169, 174, 192, 194, 195, 196, 197, 198, 204, 206, 210, 211,
        213, 215, 216, 217, 223, 224, 225, 229, 230, 234, 236, 237, 238, 239, 242, 243,
        244, 249, 251, 253, 255, 256, 258, 275, 285, 286, 287, 288, 290, 291, 292, 293,
        294, 295, 297, 300, 301, 303, 304, 309, 312, 314, 326, 330, 336, 341, 342, 343,
        346, 347, 350, 351, 352, 353, 359, 362, 365, 380, 381, 382, 383, 386, 390, 392,
        394, 395, 398, 400, 416, 422, 439, 440, 442, 448, 451, 452, 453, 454, 458, 461,
        463, 465, 466, 467, 468, 469, 470, 471, 472, 473, 474, 475, 479, 482, 485, 486,
        487, 488, 489, 490, 522, 524, 525, 527, 529, 530, 533, 534, 543, 546, 547, 548,
        549, 553, 555, 558, 560, 561, 565, 570, 571, 575, 578, 580, 582, 584, 586, 590,
        600, 601, 602, 603, 604, 605, 612, 618, 626, 629, 657, 658, 664, 665, 668, 669,
        675, 678, 679, 680, 681, 685, 687, 688, 689, 690, 691, 694, 696, 704, 707, 709,
        714, 715, 716, 717, 718, 719, 734, 738, 741, 742, 744, 746, 747, 748, 753, 755,
        760, 768, 769, 774, 776, 777, 778, 779, 781, 792, 797, 798, 801, 802, 803, 805,
        807, 808, 811, 818, 822, 823, 826, 827, 828, 829, 836, 838, 841, 845, 847, 848,
        850, 854, 858, 860, 862, 863, 864, 865, 867, 868, 871, 875, 881, 884, 886, 894,
        896, 897, 898, 900, 901, 903, 905, 915, 923, 924, 928, 932, 933, 936, 937, 938,
        944, 947, 951, 952, 954, 970, 982, 983, 984, 985, 986, 987, 995, 997, 1e3, 1002,
        1003, 1005, 1023, 1025, 1034, 1036, 1039, 1053, 1054, 1055, 1063,
      ],
      ...
      [
        ...
        157, 158, 166, 167, 169, 174, 192, 194, 195, 196, 197, 198, 204, 206, 210, 211,
        213, 215, 216, 217, 223, 224, 225, 229, 230, 234, 236, 237, 238, 239, 242, 243,
        244, 249, 251, 253, 255, 256, 258, 275, 276, 285, 286, 287, 288, 290, 291, 292,
        293, 294, 295, 297, 300, 301, 303, 304, 309, 311, 312, 314, 319, 326, 330, 336,
        341, 342, 343, 346, 347, 350, 351, 352, 353, 359, 362, 365, 380, 381, 382, 383,
        386, 390, 392, 394, 395, 398, 400, 412, 416, 418, 420, 421, 422, 424, 431, 432,
        434, 439, 440, 442, 448, 451, 452, 453, 454, 458, 461, 463, 465, 466, 467, 468,
        469, 470, 471, 472, 473, 474, 475, 479, 480, 481, 482, 483, 485, 486, 487, 488,
        489, 490, 522, 524, 525, 527, 529, 530, 533, 534, 543, 546, 547, 548, 549, 553,
        555, 558, 560, 561, 565, 570, 571, 575, 578, 580, 582, 584, 586, 590, 600, 601,
        602, 603, 604, 605, 612, 618, 626, 629, 657, 658, 660, 661, 664, 665, 668, 669,
        675, 678, 679, 680, 681, 685, 687, 688, 689, 690, 691, 694, 696, 704, 707, 709,
        714, 715, 716, 717, 718, 719, 734, 738, 741, 742, 744, 746, 747, 748, 753, 755,
        760, 768, 769, 774, 776, 777, 778, 779, 781, 792, 797, 798, 801, 802, 803, 805,
        807, 808, 811, 818, 822, 823, 826, 827, 828, 829, 836, 838, 841, 845, 847, 848,
        850, 854, 858, 860, 862, 863, 864, 865, 867, 868, 871, 875, 876, 881, 884, 886,
        894, 896, 897, 898, 900, 901, 903, 905, 915, 923, 924, 928, 932, 933, 936, 937,
        938, 944, 947, 951, 952, 954, 970, 982, 983, 984, 985, 986, 987, 995, 997, 1e3,
        1002, 1003, 1005, 1023, 1025, 1034, 1036, 1039, 1053, 1054, 1055, 1063,
      ],
      [
        106, 138, 178, 179, 180, 181, 182, 183, 184, 185, 186, 188, 189, 235, 261, 262,
        263, 264, 265, 268, 273, 348, 372, 373, 374, 375, 376, 377, 410, 411, 493, 494,
        495, 496, 497, 498, 499, 500, 501, 503, 504, 505, 506, 507, 509, 510, 511, 512,
        513, 514, 516, 519, 520, 601, 674, 737, 754, 769, 781, 957, 1013, 1014, 1015,
...
var Icon = class {
  ...
  getClass(colourMode, asArray) {
    colourMode = colourMode !== void 0 ? colourMode : null;
    asArray = asArray !== void 0 ? asArray : false;
...
var IconTables = class {
   ...
   * @return {Icon}
   */
  matchName(name2, directory) {
    directory = directory !== void 0 ? directory : false;
    ...
    if (cachedIcons[name2]) return cachedIcons[name2];
    for (var i in icons) {
      var icon = icons[i];
      if (icon.match.test(name2)) return (cachedIcons[name2] = icon);
    }
    return null;
  }
  /**
   ...
   */
  matchLanguage(name2) {
    if (cache.language[name2]) return cache.language[name2];
    for (var i in this.fileIcons.byLanguage) {
      var icon = this.fileIcons.byLanguage[i];
      if (icon.lang.test(name2)) return (cache.language[name2] = icon);
    }
    return null;
  }
  /**
   ...
   */
  matchScope(name2) {
    if (cache.scope[name2]) return cache.scope[name2];
    for (var i in this.fileIcons.byScope) {
      var icon = this.fileIcons.byScope[i];
      if (icon.scope.test(name2)) return (cache.scope[name2] = icon);
    }
    return null;
  }
  /**
   ...
   * @return {Icon}
   */
  matchInterpreter(name2) {
    if (cache.interpreter[name2]) return cache.interpreter[name2];
    for (var i in this.fileIcons.byInterpreter) {
      var icon = this.fileIcons.byInterpreter[i];
      if (icon.interpreter.test(name2)) return (cache.interpreter[name2] = icon);
    }
    return null;
  }
  /**
...
var db = new IconTables(icondb);
var getClass = (name2, match = db.matchName(name2)) => (match ? match.getClass() : null);
var getClassWithColor = (name2, match = db.matchName(name2)) =>
  match ? match.getClass(0) : null;
export { db, getClass, getClassWithColor };
